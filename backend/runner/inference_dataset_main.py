import pika, sys, os
import torch
from mq_route import inference_dataset_consumer # rabbitmq 和 训练代码之间的接口函数
...
def main():
    ...
    channel.queue_bind(exchange='dl_task', queue=queue_name, routing_key='inference_dataset')
    ...
    channel.basic_consume(queue = queue_name, on_message_callback = inference_dataset_consumer, auto_ack = True)
